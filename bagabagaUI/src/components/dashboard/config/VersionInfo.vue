...
<template>
  <div>
    ...
    <div class="project-link-container">
      <a href="https://github.com/wyeeeee/bagabaga" target="_blank" rel="noopener noreferrer" class="project-link">
        <span class="github-icon">🌸</span>
        <span class="project-text">项目地址：github.com/wyeeeee/bagabaga</span>
        <span class="github-icon">🌸</span>
      </a>
    </div>
  </div>
